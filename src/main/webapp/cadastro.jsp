...
<body>
	...
	<form action="cadastroUsuario">
		<div class="input-container">
			<label>Nome</label> <input type="text" placeholder="Informe o nome"
				name="nome" required />
		</div>
		...
		<div class="input-container">
			<label>Senha</label> <input type="password"
				placeholder="Informe a senha" name="senha" required />
		</div>

		<div class="input-container">
			<label>Confirmação da Senha</label> <input type="password"
				placeholder="Informe a senha novamente" name="confsenha" required />
		</div>
		<div class="button">
